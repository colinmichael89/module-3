...
// Add evenlistener to generateBtn
...
function generatePassword() {
  ...
  if (characterLength > 128) {
    ...
    if (characterLength < 8) {
      ...
      // set up conditional to return null if characterLength is not a number (ie user entered non-integer)
      if (characterLength > 128) {
        alert("Must choose a number between 8 and 128");
      } else {
        if (characterLength > 7 && characterLength < 129) {
          // research confirm() vs prompt()
